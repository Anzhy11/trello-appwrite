    ...
    <header>
      <div className="flex flex-col md:flex-row items-center p-5 bg-gray-500/10 rounded-b-2xl gap-y-5">
        ...
        <div className="flex items-center space-x-5 flex-1 justify-end w-full">
          ...
          {/* avatar */}
          <Avatar name="Anzhy Smooth" round size="50" color="#0055D1" />
        </div>
      </div>

      <div className="flex items-center justify-center px-5 py-2 md:py-5">
        <p className="flex items-center p-5 font-light pr-5 shadow-xl rounded-xl w-fit bg-white italic max-w-3xl text-[#0055D1]">
